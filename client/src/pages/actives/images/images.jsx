       ...
       <div className="table-responsive">
          <div className="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
           ...
           {false&&<button 
             ...
             <div className="dataTable-container dataTable-container-vh hooks-height-card-page-no-btn">
                <table className="table table-flush dataTable-table" id="datatable-search">
                   ...
                   <tr>
                     ...
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" >{translate('common.columns.image_id')}</th>              
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" >{translate('common.columns.repository')}</th>                 
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" >{translate('common.columns.version')}</th>
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" width="100px" >{translate('common.columns.created')}</th>                 
                   ...
                   {true && content?.map(entry=><tr key={String(entry.images_id)}>
                        ...
                        {false &&  <td className="text-sm font-weight-normal">
