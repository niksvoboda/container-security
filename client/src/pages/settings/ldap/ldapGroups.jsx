...
import { fetchEntrys  , fetchEntry , addEntry, updateEntry, deleteEntry} from "../../../http/api_ldaps";
             ...
             <div className="dataTable-container dataTable-container-vh hooks-vh-height">
                <table className="table table-flush dataTable-table" id="datatable-search">
                   ...
                   <tr>
                     ...
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" >{translate('common.columns.ad_groupname')}
                        </th>
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" >{translate('common.columns.local_role_id')}
                        </th>
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" width="120px">{translate('common.columns.changed')}
                        </th>  
                     <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" width="120px">{translate('common.columns.created')}
                        </th>                 
                   ...
                   <tbody>
                   {content?.map(entry=><tr key={String(entry.ad_role_id)}>
                        <td className="text-sm font-weight-normal">{entry.ad_role_id}</td>                        
                        <td className="text-sm font-weight-normal">{entry.title}</td>
                        <td className="text-sm font-weight-normal">{entry.ad_groupname}</td>
                        <td className="text-sm font-weight-normal">{entry.local_role_id}</td>
                        ...
                        <td className="text-sm font-weight-normal">
                           ...
                           onClick={event=> open_update_Entry(entry.ad_role_id)} >edit</i>
                           </td>                       
                        <td className="text-sm font-weight-normal">
                           <i className="material-icons cursor-pointer" title={translate('settings.users.delete_user')} 
                           onClick={event=> open_delete_Entry(entry.ad_role_id)}>delete</i>
                           </td>
                      </tr>)}
                   </tbody>
                </table>
